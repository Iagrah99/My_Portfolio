export const projects = [
  {
    ...
    image: [
      {
        src: "./img/nc-articles-7.jpg",
        width: 2085,
        height: 1172,
        alt: "NC News Website Articles Page Screenshot",
      },
      {
        src: "./img/nc-article-4.jpg",
        width: 2085,
        height: 1172,
        alt: "NC News Website Article Page Screenshot",
      },
      {
        src: "./img/nc-user-1.jpg",
        width: 2085,
        height: 1172,
        alt: "NC News Website User Profile Page Screenshot",
      },
      {
        src: "./img/nc-user-home-1.jpg",
        width: 2085,
        height: 1172,
        alt: "NC News Website User Home Page Screenshot",
      },
    ],
